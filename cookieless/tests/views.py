...
def my_link_rewrite_view(request):
    ...
    html += '<a href="https://localhost:8000/port-match">Port match</a>'
    html += '<a href="https://localhost:9000/port-miss">Port miss</a>'
    html += '<a href="//localhost:8000/proto-port-match">Proto port match</a>'
    html += '<a href="//localhost:9000/proto-port-miss">Proto port miss</a>'
    html += '<a href="javascript:void(0)">Js link</a>'
    html += '<a href="JaVaScRiPt:alert(1)">Js mixed case</a>'
    html += '<a href="mailto:test@example.org">Mailto</a>'
    html += '<a href="tel:+447518031909">Telephone</a>'
